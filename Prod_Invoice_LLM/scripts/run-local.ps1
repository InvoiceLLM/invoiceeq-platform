# run-local.ps1
# Local development orchestrator script for Windows (PowerShell). Run from the repo root.
# Usage:
...
function Stop-Services {
    Write-Host "1. Shutting down running dev processes (Uvicorn, Queue Worker, Next.js)..." -ForegroundColor Cyan
