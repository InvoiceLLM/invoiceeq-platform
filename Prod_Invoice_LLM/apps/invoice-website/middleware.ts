...
export const config = {
  matcher: [
    '/((?!_next/static|_next/image|favicon.ico|robots.txt|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico)|api/admin|api/audit|api/auth/me|api/autopilot|api/billing/usage|api/chat|api/connectors|api/dashboard|api/docs|api/email|api/invoices|api/outbound-audit|api/outbound-dashboard|api/outbound-invoices|api/settings|api/support|api/trainer|api/webhooks).*)',
    '/trpc/(.*)',
  ],
};
