...
| C2, C3, C4 | pending |
| C5 | **cancelled from the schedule 2026-09-04, founder-approved** — not deleted as an idea, but removed from the plan. Gate was ≥100 Azure turns and B2 verified; B2 is now verified live (Gap 422, revision `--0000131`), but telemetry shows **13 chat turns in 30 days**, which puts a 100-turn gate roughly seven months out. Do not schedule it; revisit if and when turn volume justifies it. |
...
| **C5** items 4, 3, 6 deferred | **Cancelled from the schedule 2026-09-04** (founder-approved). B2 is now resolved live, but at 13 chat turns / 30 days the ≥100-turn gate is ~7 months out. See the build-state table above. | — | — | — |
