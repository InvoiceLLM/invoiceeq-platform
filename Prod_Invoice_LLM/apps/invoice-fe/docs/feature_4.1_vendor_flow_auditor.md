...
**SENTINEL** (Invoice Risk Detection) powers this tab. Extends [feature_4_auditor.md](feature_4_auditor.md). Spec only — no implementation yet, pending approval of the full Service Flow document set.
