...
* Proxy Routes: none exist yet under `app/api/settings/email-senders/`. Backend endpoints are spec'd in `docs/feature_14_email_ingestion.md` Task 14.3 — not yet built.
