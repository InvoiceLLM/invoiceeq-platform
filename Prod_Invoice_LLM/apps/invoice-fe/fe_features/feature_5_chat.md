...
### File Coordinates
* Chat Page: [apps/invoice-fe/app/chat/page.tsx](file:///c:/Users/S%20Banerjee/Desktop/Invoice_LLM/Prod_Invoice_LLM/apps/invoice-fe/app/chat/page.tsx) *(not yet created)*
* Chat Messages Panel: [apps/invoice-fe/components/chat/MessageStream.tsx](file:///c:/Users/S%20Banerjee/Desktop/Invoice_LLM/Prod_Invoice_LLM/apps/invoice-fe/components/chat/MessageStream.tsx) *(not yet created — `components/chat/` currently holds only a `.gitkeep`)*
* SQL Audit Drawer: [apps/invoice-fe/components/chat/SqlAuditDrawer.tsx](file:///c:/Users/S%20Banerjee/Desktop/Invoice_LLM/Prod_Invoice_LLM/apps/invoice-fe/components/chat/SqlAuditDrawer.tsx) *(not yet created)*
* Proxy Routes: none exist yet under `app/api/chat/` — see "API Call Path" in `feature_1_layout_theme.md`. Backend endpoints are already live: `GET/POST /chat/sessions`, `GET /chat/sessions/{id}`, `POST /chat/sessions/{id}/message` → `run_query_agent()` (`be_features/feature_6_rag.md`)
