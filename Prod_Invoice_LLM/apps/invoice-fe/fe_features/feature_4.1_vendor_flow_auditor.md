...
Adds the pre-send validation console for outbound invoices, plus the "apply as standing rule" checkbox from [feature_7.1_vendor_flow_auditor.md](../../invoice-be/be_features/feature_7.1_vendor_flow_auditor.md).
