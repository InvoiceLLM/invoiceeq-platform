...
/**
 * Feature 10: Settings Page — /settings (the tile grid)
 *
 * FE Feature 22 Task 22.3 moved this, unchanged, out of app/settings/page.tsx:
 * with the four surfaces on, /settings is the single scrolling page
 * (SettingsSections.tsx) instead; with them off it is still this grid.
 *
...
export default function SettingsTileGrid() {
