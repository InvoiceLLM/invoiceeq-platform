...
export default function Header() {
  ...
  return (
    ...
    <header className="h-16 shrink-0 border-b border-[#222D3D] bg-[#0B0F19]/80 backdrop-blur-md flex items-center justify-between gap-2 sm:gap-3 xl:gap-3 2xl:gap-4 px-3 sm:px-4 xl:px-4 2xl:px-8 text-slate-300 z-10">
      {/* Active route's title cluster. Empty on routes that declare none. */}
      <div className="min-w-[190px] xl:min-w-[210px] flex-1 max-w-fit sm:max-w-none">{pageMeta && <PageHeader {...pageMeta} />}</div>

      {/* Right Controls Container */}
      <div className="flex items-center gap-1.5 sm:gap-2 xl:gap-2.5 2xl:gap-4 shrink-0 min-w-0">
        ...
        <div ref={actionsRef} className="flex items-center gap-1 sm:gap-1.5 2xl:gap-2.5 empty:hidden" />
