// =============================================================================
// FILE: app/api/today/[itemId]/reject/route.ts
// FEATURE: FE Feature 22 Task 22.0 — proxy for BE Feature 33
//          (apps/invoice-be/routers/today.py:388).
//
// Backend: POST /api/v1/today/{id}/reject
//   200  {ok, suppressed_kind} | {ok: false, error}
//
...
export async function POST(
  ...
  return proxyJson(request, `/today/${encodeURIComponent(params.itemId)}/reject`);
}
