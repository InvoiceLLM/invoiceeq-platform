// =============================================================================
// FILE: app/api/today/[itemId]/edit/route.ts
// FEATURE: FE Feature 22 Task 22.0 — proxy for BE Feature 33
//          (apps/invoice-be/routers/today.py:402).
//
// Backend: POST /api/v1/today/{id}/edit
//   body  {rule_text, target}
...
export async function POST(
  ...
  return proxyJson(request, `/today/${encodeURIComponent(params.itemId)}/edit`);
}
