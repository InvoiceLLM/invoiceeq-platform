...
export default function RootLayout({
  ...
  return (
    <ClerkProvider
      ...
      signInUrl={`${websiteUrl}/login`}
      signUpUrl={`${websiteUrl}/signup`}
      ...
      afterSignOutUrl={`${websiteUrl}/login`}
    >
      <html lang="en" suppressHydrationWarning>
        <head>
          <script
            dangerouslySetInnerHTML={{
              __html: `(function(){try{var t=localStorage.getItem("app_theme");if(t){document.documentElement.setAttribute("data-theme",t);}}catch(e){}})();`,
            }}
          />
        </head>
