...
Full detail for every row: `apps/invoice-be/be_features/feature_2.1/6.1/7.1/8.1/16/17_*.md`, `apps/invoice-fe/fe_features/feature_2.1/3.1/4.1/10_*.md`, `apps/invoice-website/website_features/feature_3.1_vendor_flow_pricing.md`.
