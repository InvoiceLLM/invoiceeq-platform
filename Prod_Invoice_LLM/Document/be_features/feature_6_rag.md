...
### Tasks
- [ ] **Task 6.1: Setup Chat Sessions & Threads API**
  - Implement endpoints:
...
- [ ] **Task 6.2: Create Document Chunking Pipeline**
  - Implement recursive chunking (1,000 token max, 200 token overlap) parsing structural elements.
- [ ] **Task 6.3: Configure Embedding Calculations**
  - Code local embedding vectors generation using the `BAAI/bge-m3` model via the `sentence-transformers` library.
- [ ] **Task 6.4: Setup ChromaDB Collections & Metadata Isolation**
...
- [ ] **Task 6.5: Build Query Agent with Memory Checkpointer & SQL Drawer**
