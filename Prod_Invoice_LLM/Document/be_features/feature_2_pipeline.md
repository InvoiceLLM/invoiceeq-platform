...
### Tasks
- [ ] **Task 2.1: Implement Ingestion Router Endpoint**
...
- [ ] **Task 2.2: Persist Files to Azure Blob Storage**
...
- [ ] **Task 2.3: Create Processing DB Entry**
...
- [ ] **Task 2.4: Dispatch Celery Extraction Task**
...
- [ ] **Task 2.5: Enforce Free Plan 50 Invoice limit**
...
- [ ] **Task 2.6: Update SQLModel Schema with Optional Columns**
