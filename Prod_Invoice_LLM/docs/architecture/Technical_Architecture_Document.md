...
| Chat (direction-aware) | `docs/feature_6.1_vendor_flow_chat.md` | — (no FE-specific spec; UI is the existing Chat screen) |
| Settings | `docs/feature_16_settings.md` | `docs/feature_10_settings.md` |
| Invoice generation/branding | `docs/feature_17_invoice_builder.md` (deferred placeholder) | — |
