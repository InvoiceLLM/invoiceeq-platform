...
| `items` | `JSONB` | `NULL` | List of individual extracted line items (e.g. description, quantity, unit_price, amount) stored as a native JSON array. |
